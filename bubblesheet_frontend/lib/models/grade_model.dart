  ...
  factory GradeModel.fromJson(Map<String, dynamic> json) {
    return GradeModel(
      ...
      score: json['score'] != null
          ? (json['score'] is int ? json['score'].toDouble() : json['score'])
          : null,
...
class ItemAnalysisModel {
  ...
  factory ItemAnalysisModel.fromJson(Map<String, dynamic> json) {
    return ItemAnalysisModel(
      ...
      totalPapers: json['total_papers'] is int
          ? json['total_papers']
          : int.tryParse(json['total_papers']?.toString() ?? '') ?? 0,
  ...
  factory ItemModel.fromJson(Map<String, dynamic> json) {
    return ItemModel(
      questionNumber: json['question_number'] is int
          ...
          : int.tryParse(json['question_number']?.toString() ?? '') ?? 0,
      correctAnswer: json['correct_answer']?.toString() ?? '',
      correctCount: json['correct_count'] is int
          ? json['correct_count']
          : int.tryParse(json['correct_count']?.toString() ?? '') ?? 0,
      incorrectCount: json['incorrect_count'] is int
          ? json['incorrect_count']
          : int.tryParse(json['incorrect_count']?.toString() ?? '') ?? 0,
      blankCount: json['blank_count'] is int
          ? json['blank_count']
          : int.tryParse(json['blank_count']?.toString() ?? '') ?? 0,
      correctPercent: json['correct_percent'] is double
          ? json['correct_percent']
          : (json['correct_percent'] is int
                ? json['correct_percent'].toDouble()
                : double.tryParse(json['correct_percent']?.toString() ?? '') ??
                      0.0),
      incorrectPercent: json['incorrect_percent'] is double
          ? json['incorrect_percent']
          : (json['incorrect_percent'] is int
                ? json['incorrect_percent'].toDouble()
                : double.tryParse(
                        json['incorrect_percent']?.toString() ?? '',
                      ) ??
                      0.0),
      blankPercent: json['blank_percent'] is double
          ? json['blank_percent']
          : (json['blank_percent'] is int
                ? json['blank_percent'].toDouble()
                : double.tryParse(json['blank_percent']?.toString() ?? '') ??
                      0.0),
    );
  }
}
...
class StatisticsModel {
  ...
  factory StatisticsModel.fromJson(Map<String, dynamic> json) {
    return StatisticsModel(
      minScore: json['min_score'] is double
          ? json['min_score']
          : (json['min_score'] is int
                ? json['min_score'].toDouble()
                : double.tryParse(json['min_score']?.toString() ?? '') ?? 0.0),
      maxScore: json['max_score'] is double
          ? json['max_score']
          : (json['max_score'] is int
                ? json['max_score'].toDouble()
                : double.tryParse(json['max_score']?.toString() ?? '') ?? 0.0),
      averageScore: json['average_score'] is double
          ? json['average_score']
          : (json['average_score'] is int
                ? json['average_score'].toDouble()
                : double.tryParse(json['average_score']?.toString() ?? '') ??
                      0.0),
      averagePercent: json['average_percent'] is double
          ? json['average_percent']
          : (json['average_percent'] is int
                ? json['average_percent'].toDouble()
                : double.tryParse(json['average_percent']?.toString() ?? '') ??
                      0.0),
      medianScore: json['median_score'] is double
          ? json['median_score']
          : (json['median_score'] is int
                ? json['median_score'].toDouble()
                : double.tryParse(json['median_score']?.toString() ?? '') ??
                      0.0),
      stdDeviation: json['std_deviation'] is double
          ? json['std_deviation']
          : (json['std_deviation'] is int
                ? json['std_deviation'].toDouble()
                : double.tryParse(json['std_deviation']?.toString() ?? '') ??
                      0.0),
    );
  }
}
