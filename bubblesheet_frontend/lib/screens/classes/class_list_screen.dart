  ...
  Widget build(BuildContext context) {
    return Consumer<ClassProvider>(
      builder: (context, classProvider, child) {
        ...
        final List<ClassModel> pageData = _filteredClasses
                          ...
                          : () async {
                              final confirm = await showDialog<bool>(
                                ...
                                builder: (context) => AlertDialog(
                                  ...
                                  content: const Text(
                                    'Deleting classes will remove the class, but does not delete students or their papers. Continue?',
                                  ),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
                              ...
                              if (confirm == true) {
                                ...
                                setState(() {
                                  ...
                                  _filterClasses(
                                    context.read<ClassProvider>().classes,
                                  );
                                });
                              }
                            },
                          ...
                          children: [
                            ...
                            TableCell(
                              verticalAlignment:
                                  TableCellVerticalAlignment.middle,
                              child: Center(
                                child: Text('${classItem.class_code}'),
                              ),
                            ),
                            TableCell(
                              verticalAlignment:
                            ...
                            TableCell(
                              verticalAlignment:
                                  TableCellVerticalAlignment.middle,
                              child: Center(
                                child: Text('${classItem.student_count}'),
                              ),
                            ),
                            TableCell(
                              verticalAlignment:
                              ...
                              child: Center(
                                child: IconButton(
                                  ...
                                  onPressed: () {
                                    context.go(
                                      '/classes/${classItem.class_code}/students',
                                    );
                                  },
                                ),
                              ),
                            ...
                            TableCell(
                              ...
                              child: Center(
                                child: IconButton(
                                  ...
                                  onPressed: () {
                                    context.go(
                                      '/classes/${classItem.class_code}/gradebook',
                                    );
                                  },
                                ),
                              ),
