...
class ClassEditStudentsScreen extends StatefulWidget {
  ...
  const ClassEditStudentsScreen({Key? key, required this.classCode})
    : super(key: key);

  @override
  State<ClassEditStudentsScreen> createState() =>
      _ClassEditStudentsScreenState();
}
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          children: [
                            const Text(
                              'Click to add students to the class roster on left:',
