  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<ExamProvider>(
      builder: (context, examProvider, child) {
        ...
        final List<ExamModel> pageData = _filteredExams
                          ...
                          : () async {
                              final confirm = await showDialog<bool>(
                                ...
                                builder: (context) => AlertDialog(
                                  ...
                                  content: const Text(
                                    'Deleting quizzes will remove their associated papers and cannot be undone.  Continue?',
                                  ),
                                  actions: [
                                    TextButton(
                                      onPressed: () =>
                              ...
                              if (confirm == true) {
                                await context.read<ExamProvider>().deleteExams(
                                  context,
                                  _selectedExamIds.toList(),
                                );
                                setState(() {
                                  _selectedExamIds.clear();
                                  _filterExams(
                                    context.read<ExamProvider>().exams,
                                  );
                                });
                              }
                            },
                            ...
                            child: Center(
                              child: Checkbox(
                                value:
                                    pageData.isNotEmpty &&
                                    pageData.every(
                                      (c) => _selectedExamIds.contains(c.id),
                                    ),
                                onChanged: (selected) {
                                  setState(() {
                                    if (selected == true) {
                                      ...
                                      _selectedExamIds.removeWhere(
                                        (id) => pageData.any((c) => c.id == id),
                                      );
                                    }
                                  });
                                },
                              ...
                              child: Center(
                                child: Text(
                                  examItem.class_codes
                                      .map(
                                        (code) => classCodeToName[code] ?? code,
                                      )
                                      .join(', '),
                                ),
                              ),
