...
class _StudentFormScreenState extends State<StudentFormScreen> {
  ...
  Future<void> _fetchStudent() async {
    ...
    try {
      ...
      final student = await provider.fetchStudentById(
        context,
        widget.studentId!,
      );
      ...
      setState(() {
        _error = 'Failed to load student info';
      });
    } finally {
      setState(() {
        _isLoading = false;
  ...
  Future<void> _submit() async {
    ...
    try {
      ...
      if (_isEdit) {
        ...
        setState(() {
          _success = 'Student updated successfully!';
        });
      } else {
        await provider.addStudent(context, data);
        setState(() {
          _success = 'Student created successfully!';
        });
      }
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              Text(
                _isEdit
                    ? 'Edit Student: ${_firstNameController.text} ${_lastNameController.text}'
                    : 'Add New Student',
