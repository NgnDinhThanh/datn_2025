...
class AnswerSheetFormHeaderScreen extends StatefulWidget {
  ...
  @override
  State<AnswerSheetFormHeaderScreen> createState() =>
      _AnswerSheetFormHeaderScreenState();
}

class _AnswerSheetFormHeaderScreenState
    extends State<AnswerSheetFormHeaderScreen> {
                ...
                children: [
                  TableRow(
                    ...
                    children: const [
                      ...
                      TableCell(
                        child: Center(
                          child: Text('Displayed Label On Answer Sheet'),
                        ),
                      ),
