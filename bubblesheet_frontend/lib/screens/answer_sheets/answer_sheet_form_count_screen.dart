...
class AnswerSheetFormCountScreen extends StatefulWidget {
  ...
  @override
  State<AnswerSheetFormCountScreen> createState() =>
      _AnswerSheetFormCountScreenState();
}

class _AnswerSheetFormCountScreenState
    extends State<AnswerSheetFormCountScreen> {
      ...
      child: Container(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              const Text(
                'Step 3 of 5: Key Version and Student/Class/Exam ID',
